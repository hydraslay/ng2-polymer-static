/* Suggested Name File: paper-item-directives.ts */
...
export class PaperItemChangeEventsAdapterDirective {
    activeChange: any;
    focusedChange: any;
    disabledChange: any;
...
export class PaperItemValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-item',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperItemFormElementDirective), multi: true }],
    host: { '(valueChange)': 'onValueChanged($event)' }
})
export class PaperItemFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperItemNotifyForDiffersDirective implements OnInit, DoCheck {
    keyEventTarget: any;
    _element: any;
...
export class PaperItemReloadConfigurationDirective {
