/* Suggested Name File: paper-radio-group-directives.ts */
...
export class PaperRadioGroupChangeEventsAdapterDirective {
    ...
    constructor() {
        ...
        this[this.eventNameForProperty('items')] = new EventEmitter<any>(false);
        this[this.eventNameForProperty('selectedValues')] = new EventEmitter<any>(false);
        this[this.eventNameForProperty('selectedItems')] = new EventEmitter<any>(false);
    }
...
export class PaperRadioGroupValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-radio-group',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperRadioGroupFormElementDirective), multi: true }],
    host: { '(valueChange)': 'onValueChanged($event)' }
})
export class PaperRadioGroupFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperRadioGroupNotifyForDiffersDirective implements OnInit, DoCheck {
    _element: any;
    _iterableDiffers: any;
    _keyValueDiffers: any;
    _differs: any;
    _arrayDiffs: any;
    arrayAndObjectProperties: any[] = ["selectedValues", "keyEventTarget"];
...
export class PaperRadioGroupReloadConfigurationDirective {
