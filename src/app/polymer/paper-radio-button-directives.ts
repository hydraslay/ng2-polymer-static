/* Suggested Name File: paper-radio-button-directives.ts */
...
export class PaperRadioButtonChangeEventsAdapterDirective {
    ...
    constructor() {
        ...
        this[this.eventNameForProperty('checked')] = new EventEmitter<any>(false);
    }
...
export class PaperRadioButtonValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-radio-button',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperRadioButtonFormElementDirective), multi: true }],
    host: { '(checkedChange)': 'onValueChanged($event)' }
})
export class PaperRadioButtonFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperRadioButtonReloadConfigurationDirective {
