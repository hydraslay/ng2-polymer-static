/* Suggested Name File: paper-icon-button-directives.ts */
...
export class PaperIconButtonChangeEventsAdapterDirective {
...
export class PaperIconButtonValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-icon-button',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperIconButtonFormElementDirective), multi: true }],
    host: { '(valueChange)': 'onValueChanged($event)' }
})
export class PaperIconButtonFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperIconButtonNotifyForDiffersDirective implements OnInit, DoCheck {
    _element: any;
...
export class PaperIconButtonReloadConfigurationDirective {
