/* Suggested Name File: paper-dialog-directives.ts */
...
export class PaperDialogChangeEventsAdapterDirective {
...
export class PaperDialogValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-dialog',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperDialogFormElementDirective), multi: true }],
    host: { '(valueChange)': 'onValueChanged($event)' }
})
export class PaperDialogFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperDialogNotifyForDiffersDirective implements OnInit, DoCheck {
    _element: any;
    _iterableDiffers: any;
    _keyValueDiffers: any;
    _differs: any;
    _arrayDiffs: any;
    arrayAndObjectProperties: any[] = ["sizingTarget", "fitInto", "closingReason", "animationConfig"];
...
export class PaperDialogReloadConfigurationDirective {
