/* Suggested Name File: paper-dialog-scrollable-directives.ts */
...
export class PaperDialogScrollableChangeEventsAdapterDirective {
...
export class PaperDialogScrollableValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-dialog-scrollable',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperDialogScrollableFormElementDirective), multi: true }],
    host: { '(valueChange)': 'onValueChanged($event)' }
})
export class PaperDialogScrollableFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperDialogScrollableNotifyForDiffersDirective implements OnInit, DoCheck {
    ...
    _differs: any;
    _arrayDiffs: any;
    arrayAndObjectProperties: any[] = ["dialogElement"];
...
export class PaperDialogScrollableReloadConfigurationDirective {
