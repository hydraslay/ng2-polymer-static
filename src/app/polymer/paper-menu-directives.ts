/* Suggested Name File: paper-menu-directives.ts */
...
export class PaperMenuValidationDirective implements DoCheck {
    _element: any;
...
@Directive({
    selector: 'paper-menu',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => PaperMenuFormElementDirective), multi: true }],
    host: { '(valueChange)': 'onValueChanged($event)' }
})
export class PaperMenuFormElementDirective {
    _element: any;
    _renderer: any;
...
export class PaperMenuReloadConfigurationDirective {
