...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_19", {
        get: function () {
            if ((this.__EventManager_19 == null)) {
                (this.__EventManager_19 = new import14.EventManager(this._EVENT_MANAGER_PLUGINS_18, this.parent.get(import32.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_23", {
        get: function () {
            if ((this.__RootRenderer_23 == null)) {
                (this.__RootRenderer_23 = import33._createConditionalRootRenderer(this._DomRootRenderer_22, this.parent.get(import33.NgProbeToken, null), this.parent.get(import11.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AnimationQueue_26", {
        get: function () {
            if ((this.__AnimationQueue_26 == null)) {
                (this.__AnimationQueue_26 = new import18.AnimationQueue(this.parent.get(import32.NgZone)));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__12 = new import11.ApplicationRef_(this.parent.get(import32.NgZone), this.parent.get(import34.Console), this, this._ErrorHandler_9, this, this._ApplicationInitStatus_10, this.parent.get(import10.TestabilityRegistry, null), this._Testability_11);
