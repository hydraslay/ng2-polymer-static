...
export class Wrapper_PaperDropdownMenuChangeEventsAdapterDirective {
  /*private*/ _eventHandler:Function;
  context:import0.PaperDropdownMenuChangeEventsAdapterDirective;
  ...
  handleEvent(eventName:string,$event:any):boolean {
    ...
    if ((eventName == 'selected-item-label-changed')) {
      const pd_sub_5:any = ((<any>this.context._emitChangeEvent('selectedItemLabel',$event)) !== false);
      result = (pd_sub_5 && result);
    }
    if ((eventName == 'selected-item-changed')) {
      const pd_sub_6:any = ((<any>this.context._emitChangeEvent('selectedItem',$event)) !== false);
      result = (pd_sub_6 && result);
    }
    if ((eventName == 'opened-changed')) {
      const pd_sub_7:any = ((<any>this.context._emitChangeEvent('opened',$event)) !== false);
  ...
  subscribe(view:import1.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean,emit2:boolean,emit3:boolean,emit4:boolean,emit5:boolean,emit6:boolean,emit7:boolean):void {
    ...
    if (emit4) { (this.subscription4 = this.context.selectedItemLabelChange.subscribe(_eventHandler.bind(view,'selectedItemLabelChange'))); }
    if (emit5) { (this.subscription5 = this.context.selectedItemChange.subscribe(_eventHandler.bind(view,'selectedItemChange'))); }
    if (emit6) { (this.subscription6 = this.context.valueChange.subscribe(_eventHandler.bind(view,'valueChange'))); }
    if (emit7) { (this.subscription7 = this.context.openedChange.subscribe(_eventHandler.bind(view,'openedChange'))); }
  }
}
export class Wrapper_PaperDropdownMenuNotifyForDiffersDirective {
  /*private*/ _eventHandler:Function;
  context:import0.PaperDropdownMenuNotifyForDiffersDirective;
  /*private*/ _changed:boolean;
  /*private*/ _expr_0:any;
...
export class Wrapper_PaperDropdownMenuFormElementDirective {
  /*private*/ _eventHandler:Function;
  context:import0.PaperDropdownMenuFormElementDirective;
  /*private*/ _changed:boolean;
...
export class Wrapper_PaperDropdownMenuValidationDirective {
  /*private*/ _eventHandler:Function;
  context:import0.PaperDropdownMenuValidationDirective;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any) {
    this._changed = false;
...
export class Wrapper_PaperDropdownMenuReloadConfigurationDirective {
  /*private*/ _eventHandler:Function;
  context:import0.PaperDropdownMenuReloadConfigurationDirective;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any) {
    this._changed = false;
